...
def transform_cam_wrt_base(pcd, T_end_effector_wrt_base):
        ...
        # Translation: [0.026, 0.000, 0.004]
        # - Rotation: in Quaternion [-0.002, -0.001, -0.001, 1.000]
        ...
        # - Translation: [-0.026, -0.000, -0.004]
        # - Rotation: in Quaternion [0.002, 0.001, 0.001, 1.000]
        #             in RPY (radian) [0.004, 0.002, 0.001]
        #             in RPY (degree) [0.224, 0.089, 0.071]


    # T_color_depth =  np.array( [[  0.999996,    0.00200399, -0.00199599,  0.026],
    #                         [ -0.00199599,  0.99999,     0.00400198, 0],
    #                         [ 0.00200399, -0.00399798,  0.99999 ,  0.004 ],
    #                         [ 0.        ,  0.        ,  0.         , 1.      ]])
    # T_color_depth =  np.array( [[  0.999996 ,  -0.00199599,  0.00200399,  0.026],
    #                         [ 0.00200399,  0.99999 ,   -0.00399798, 0],
    #                         [ -0.00199599,  0.00400198,  0.99999,  0.004 ],
    #                         [ 0.        ,  0.        ,  0.         , 1.      ]])

    # T_color_depth =  np.array( [[  1 ,  0,  0,  0.026],
    # [ 0, 1,   0, 0],
    # [ 0,  0,  1,  0.004 ],
    # [ 0.        ,  0.        ,  0.         , 1.      ]])

    # pcd_copy0 = copy.deepcopy(pcd).transform(T_color_depth)
    # pcd_copy0.paint_uniform_color([0.5, 0.5, 1])



    # T_cam_wrt_end_effector = np.array( [[ 0.01123109, -0.99993471,  0.00210891,  0.12427207],
    #                         [ 0.99992799,  0.01122204, -0.00425328, -0.12805544],
    #                         [ 0.00422933 , 0.00215653,  0.99998873,  0.1065766 ],
    #                         [ 0.        ,  0.        ,  0.         , 1.        ]])
    ...
    # T_cam_wrt_end_effector = np.array( [[ 0.01549882, -0.99986857, 0.00475615, 0.12312214],
    #                                     [ 0.99987647, 0.01548615, -0.00268809, -0.12866016],
    #                                     [ 0.00261408, 0.00479722, 0.99998508, 0.10678095],
    #                                     [ 0., 0., 0., 1. ]])
...
def detect_groove_workflow(pcd, transfromation_end_to_base, detect_feature="asymmetry" , show_groove=False, publish=True, save_data=False):
    ...
    global max_dis, total_time, voxel_size
    ...
    delete_points = int(pc_number*0.9)
...
if __name__ == "__main__":
    ...
    # -- Set subscriber
    global received_ros_cloud, max_dis, total_time, voxel_size, neighbor, is_first_pose, is_sec_pose
