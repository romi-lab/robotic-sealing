...
def process_pre_roi(limg, tip_pos):
    ...
    if noedge == True and math.isnan(lk1)==False:
        # first detetion
        noedge = False
        count_nan = 0
    
    elif noedge == False:
        if not math.isnan(lk1):
            count_nan = 0
        else:
            count_nan += 1
            lk1 = k1_list[-1]
    ...
    if noedge == False and math.isnan(lk1)==False and math.isnan(lk2)==False:
        ...
        # a1 = int((b1-lb1)/lk1)
        # a2 = int((b2-lb1)/lk1)
        # cv2.line(frame,(a1,b1),(a2,b2),(255,255,255),2)
        # p1 = [a1,b1]
        ...
        # cv2.line(frame,(a2,b2),(a3,b3),(0,0,0),4)

        # projection = ClosestPointOnLine(p2, p3, tip_pos)
        ...
        ca2 = int((cb2-lb1)/lk1)
        cv2.line(frame,(ca1,cb1),(ca2,cb2),(255,255,255),2)
