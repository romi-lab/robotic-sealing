...
def process_pre_roi_getkb(limg, tip_pos):
    ...
    edges = cv2.Canny(gray,60,80,apertureSize = 3) #apertureSize size of kernal
...
if __name__ == '__main__':
    ...
    try:
        ...
        # capture = cv2.VideoCapture('/home/maggie/ros/feedback/sealing_video/1_web.avi')
        # capture = cv2.VideoCapture('/home/maggie/ros/feedback/sealing_video/2_web.avi')
